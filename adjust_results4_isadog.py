    ...
    with open(dogfile, "r") as infile:
        ...
        for line in infile:
            ...
            if dog_name not in dognames_dic:
                ...
                print(f"Warning: Duplicate dog name '{dog_name}' found in file.")

    # Adjust the results dictionary based on dog names
    for key in results_dic:
        # Pet Image Label is a Dog
        is_pet_dog = 1 if results_dic[key][0] in dognames_dic else 0

        # Classifier Label is a Dog (multiple labels split by commas)
        is_classifier_dog = 0
        ...
        # Add is-dog status to results_dic
